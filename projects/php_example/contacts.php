...
$result = mysqli_query($db,"SELECT title,meta_d,meta_k,text FROM settings WHERE page='contacts'");
...
<div class="ftr">
   <a style="width:99%;" class="btn fclr" href="../phpsite"><img alt="+" src="./files/guild.png" width="16" height="16"> phpsite
   <span style="font-weight:normal;"><span class="amount"></span></span></a>
</div>

<div class="ftr">
   <a style="width:99%;" class="btn fclr" href="./admin/"><img alt="+" src="./files/guild.png" width="16" height="16"> admin
   <span style="font-weight:normal;"><span class="amount"></span></span></a>
</div>
