...
<form id="form1" name="form1" method="post" action="add_exchange.php">
            <p>
          ...
          <input type="text" name="exchange_name" id="exchange_name" />
            ...
            <p>
              <label>Введите примечание<br />
              <input name="description" id="description" />
              </label>
            </p>
            <p>
              <label>Введите имя файла картинки<br />
              <input name="image" id="image" />
              </label>
            </p>                                               
            <p>
              <label>
              <input type="submit" name="submit" id="submit" value="Добавить валюту" />
              </label>
            </p>
        </form>
