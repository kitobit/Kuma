...
<?php 
		...
		if  (isset($exchange_name) && isset($description))
			 ...
			 {
			 $result = mysqli_query($db,"UPDATE exchange SET exchange_name = '$exchange_name',
			 ...
			 WHERE id = '$id'");
			  ...
			  if ($result  == 'true') 
			  {
			  echo "<p>Валюта успешно обновлена</p>"; 
			  }
			 else
			 { 
			 echo "<p>Валюта не обновлена</p>";
			 }			  
			  
			 }
			 else
			 { 
			 echo "<p>Вы ввени не всю информацию. Валюта не будет обновлена</p>";
			 }
