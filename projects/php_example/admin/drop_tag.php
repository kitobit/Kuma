...
<div class="hr"></div>
		...
		if  (isset($id))
			 ...
			 {
			 $result = mysqli_query($db,"DELETE FROM garage_tegs_html WHERE id = '$id'");
					
			  if ($result  == 'true') 
			  {
			  echo "<p>Ваш тег успешно удален</p>"; 
			  }
			 else
			 { 
			 echo "<p>Ваш тег не удален</p>";
			 }			  
			  
			 }
			 else
			 { 
			 echo "<p>Не выбран тег для удаления</p>";
			 }
